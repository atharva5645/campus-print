...
function CartSummary({
  ...
  return (
    <div className="overflow-hidden rounded-[2rem] border border-white/30 bg-surface-container-highest/85 shadow-[0_24px_48px_rgba(32,48,68,0.10)] backdrop-blur-xl">
      ...
      <div className="space-y-4 p-5 sm:p-6">
        ...
        <div className="border-t border-outline-variant/20 pt-4">
          ...
          <p className="mt-2 text-xs text-on-surface-variant">
            Rs {pricePerPage} x {pages} pages x {quantity} qty
          </p>
        </div>
        ...
        <button
          type="button"
          onClick={onAction}
          className="mt-2 flex w-full items-center justify-center gap-3 rounded-2xl bg-primary px-6 py-4 font-headline font-bold text-white shadow-[0_10px_20px_rgba(74,64,224,0.3)] transition-all active:scale-95"
        >
